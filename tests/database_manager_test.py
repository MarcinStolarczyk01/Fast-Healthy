...
EXAMPLE_PRODUCTS = {
    "products": [
        ...
        {
            "name": "butter",
            "macro": {"fat": 81, "protein": 0.9, "carbohydrates": 0.1},
            "unit": "g",
        },
    ]
}
...
def test_load_products_should_return_correct_list_of_products():
    ...
    expected_output = [
        ...
        Product(
            name="wholemeal bread", unit="g", fat=1.7, protein=5.9, carbohydrates=51.2
        ),
        Product(name="butter", unit="g", fat=81, protein=0.9, carbohydrates=0.1),
    ]
